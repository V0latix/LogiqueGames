...
from .model import Cell, ZipSolution
from .parser import parse_puzzle_dict
from .solver_counting import count_solutions
    ...
    while attempts < max_attempts:
        ...
        for checkpoint_spec in checkpoint_levels:
            ...
            for wall_count in range(0, min(max_walls, len(wall_edges)) + 1):
                ...
                if ensure_unique:
                    count_result = count_solutions(puzzle, time_limit_s=unique_timelimit_s, max_solutions=2)
                    if count_result.timed_out or count_result.solutions != 1:
                        continue
